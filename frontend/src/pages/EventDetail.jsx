    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div
                    className="relative rounded-2xl overflow-hidden h-56 md:h-72 mb-6 bg-gradient-to-br from-indigo-500 to-purple-600">
                    {event.banner_image ? (
            ...
            <span className={`text-xs font-bold px-3 py-1 rounded-full capitalize ${catColor}`}>
              {event.category}
                    ...
                    {isPast && (
                        <div
                            className="absolute top-4 right-4 bg-black/60 text-white text-xs font-bold px-3 py-1 rounded-full">
                            Past Event
                        </div>
                    )}
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-5 grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-semibold text-gray-900">
                                    ...
                                    {endDate && ` — ${endDate.toLocaleTimeString('en-BD', {
                                        hour: '2-digit',
                                        minute: '2-digit'
                                    })}`}
                                </p>
                    ...
                    <div className="space-y-4">
                        ...
                        {!isOwner && !isPast && (
                            <div className="bg-white rounded-2xl border border-gray-200 p-5">
                                ...
                                {event.is_full && event.user_rsvp !== 'going' ? (
                                    <div
                                        className="text-center py-3 bg-red-50 rounded-xl text-sm text-red-600 font-semibold">
                                        Event is full
                                    </div>
                                ) : (
                                ...
                                {!isAuthenticated && (
                                    <p className="text-xs text-center text-gray-500 mt-3">
                                        <button onClick={() => navigate('/login')}
                                                className="text-indigo-600 font-semibold">Login
                                        </button>
                                        to RSVP
                                    </p>
                                )}
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-5">
                            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-3">Organized
                                by</h3>
                            <div className="flex items-center gap-3">
                                <div
                                    className="w-10 h-10 rounded-full bg-purple-600 text-white font-bold text-sm flex items-center justify-center">
                        ...
                        {isOwner && (
                            <div className="bg-white rounded-2xl border border-gray-200 p-5 space-y-2">
                                <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-3">Manage
                                    Event</h3>
