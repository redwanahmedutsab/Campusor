...
const features = [
  { icon: '🛍️', title: 'Marketplace',  desc: 'Buy and sell textbooks, electronics, and more between students.',  path: '/marketplace' },
  { icon: '🎉', title: 'Events',        desc: 'Discover and RSVP to campus events, workshops, and activities.',    path: '/events' },
  { icon: '🔍', title: 'Lost & Found',  desc: 'Post lost items or report found ones to reunite with their owners.', path: '/lost-found' },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900 text-white">
        <div className="max-w-5xl mx-auto px-6 py-24 text-center">
          <div className="inline-flex items-center gap-2 bg-indigo-500/20 border border-indigo-500/30 text-indigo-300 text-sm font-semibold px-4 py-1.5 rounded-full mb-8">
            🎓 Your University Hub
          </div>
          ...
          <p className="text-slate-300 text-lg max-w-xl mx-auto mb-10">
            Campusor connects students to buy, sell, discover events, and find lost items — all in one place.
          </p>
      ...
      <section className="bg-slate-900 text-white">
        <div className="max-w-5xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-slate-400 mb-8">Sign up for free and connect with students at your university.</p>
          <button
            onClick={() => navigate('/register')}
