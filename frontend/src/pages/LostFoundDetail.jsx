        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                    <button onClick={() => navigate('/lost-found')} className="hover:text-indigo-600">Lost & Found
                    </button>
                    <span>›</span>
                        ...
                        <div className={`relative rounded-2xl overflow-hidden h-64 bg-gradient-to-br ${typeStyle.bg}`}>
                            ...
                            {item.status === 'resolved' && (
                                <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                                    <span
                                        className="bg-green-500 text-white font-black px-5 py-2 rounded-full text-base">RESOLVED ✓</span>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-4 grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-semibold text-gray-900">
                                    📅 {new Date(item.date_occurred).toLocaleDateString('en-BD', {
                                    month: 'long',
                                    day: 'numeric',
                                    year: 'numeric'
                                })}
                            ...
                            <div>
                                <p className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-1">Posted
                                    by</p>
