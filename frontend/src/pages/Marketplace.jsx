          ...
          <aside className="hidden md:block w-56 shrink-0">
            <div className="bg-white rounded-2xl border border-gray-200 p-4 sticky top-20">
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => setFilters({ search: '', category: '', condition: '', is_free: '', ordering: '-created_at' })}
                  className="text-xs text-indigo-600 font-semibold hover:underline">Clear</button>
              </div>
