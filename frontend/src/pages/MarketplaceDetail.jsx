        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-5xl mx-auto px-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                    <button onClick={() => navigate('/marketplace')} className="hover:text-indigo-600">Marketplace
                    </button>
                    <span>›</span>
                        ...
                        <div className="relative bg-gray-100 rounded-2xl overflow-hidden h-80 md:h-96">
                            ...
                            {product.status === 'sold' && (
                                <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                                    <span
                                        className="bg-red-500 text-white font-black text-xl px-6 py-2 rounded-full">SOLD</span>
                                </div>
                            )}
                        </div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            <div className="flex items-start justify-between gap-3 mb-2">
                                ...
                                <span
                                    className={`text-xs font-bold px-3 py-1.5 rounded-full shrink-0 ${condition.color}`}>
                  {condition.label}
                </span>
                            </div>
                            ...
                            {product.category_name && (
                                <span
                                    className="inline-block mt-2 text-xs text-gray-500 bg-gray-100 px-3 py-1 rounded-full">
                  {product.category_name}
                </span>
                            )}
                        </div>
                        ...
                        <div className="bg-white rounded-2xl border border-gray-200 p-4">
                            ...
                            <div className="flex items-center gap-3 mb-3">
                                <div
                                    className="w-10 h-10 rounded-full bg-indigo-600 text-white font-bold text-sm flex items-center justify-center">
                      ...
                      <span className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-4 text-xs text-gray-400 pt-2">
                            ...
                            <span>📅 {new Date(product.created_at).toLocaleDateString('en-BD', {
                                month: 'short',
                                day: 'numeric',
                                year: 'numeric'
                            })}</span>
